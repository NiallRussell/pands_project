...
df_upper.pivot(columns='Species', values='Sepal Length').plot.hist(alpha = .5, color = ["lawngreen", "cyan", "lightcoral"], edgecolor = "white", bins = 40)
plt.xlabel("Sepal Length (cm)")
plt.ylabel("Frequency")
plt.savefig('sepal_length.png')
plt.close()

df_upper.pivot(columns='Species', values='Sepal Width').plot.hist(alpha = .5, color = ["lawngreen", "cyan", "lightcoral"], edgecolor = "white", bins = 40)
plt.xlabel("Sepal Width (cm)")
plt.ylabel("Frequency")
plt.savefig('sepal_width.png')
plt.close()

df_upper.pivot(columns='Species', values='Petal Length').plot.hist(alpha = .5, color = ["lawngreen", "cyan", "lightcoral"], edgecolor = "white", bins = 40)
plt.xlabel("Petal Length (cm)")
plt.ylabel("Frequency")
plt.savefig('petal_length.png')
plt.close()

df_upper.pivot(columns='Species', values='Petal Width').plot.hist(alpha = .5, color = ["lawngreen", "cyan", "lightcoral"], edgecolor = "white", bins = 40)
